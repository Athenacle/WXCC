...
BinFunction NS_EXPRE_IR::op2fun(const OP _op)
{
	switch (_op)
	{
	case OP_PLUS	:	return Tree::PLUStree;
	case OP_MINUS	:	return Tree::MINUStree;
	case OP_MOD	:	return Tree::MODtree;
	case OP_BITOR	:	return Tree::BITORtree;
	case OP_BITAND	:	return Tree::BITANDtree;
	case OP_MULT	:	return Tree::MULTtree;
	case OP_BITXOR	:	return Tree::BITXORtree;
	case OP_DIV	:	return Tree::DIVtree;
	case OP_LEFTSHIFT:	return Tree::SHLtree;
	case OP_RIGHTSHIFT:	return Tree::SHRtree;
	case OP_LE	:	return Tree::LEtree;
	case OP_GT	:	return Tree::GTtree;
	case OP_LT	:	return Tree::LTtree;
	case OP_GE	:	return Tree::GEtree;
	case OP_EQ	:	return Tree::EQtree;
	case OP_NE	:	return Tree::NEtree;
	default		:	assert(0);
	}
	return NULL;
}
