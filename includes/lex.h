...
namespace NS_LEX_TOOLS
{
    ...
    {
        return is(_tok, T_KEY)
               && (_tok.token_value.keyword == KEY_RETURN || _tok.token_value.keyword == KEY_BREAK
    ...
    {
        return is(_tok, T_KEY)
               && (_tok.token_value.keyword == KEY_SWITCH || _tok.token_value.keyword == KEY_IF);
    }

    bool inline isLabel(const Token &_tok)
    {
        return is(_tok, T_KEY)
               && (_tok.token_value.keyword == KEY_CASE || _tok.token_value.keyword == KEY_DEFAULT);
    }
